...
Be creative with colors and fonts in TwentyEleven. Styles changes everything.

== Description ==

This plugin adds suport for the TwentyEleven theme to the [Styles plugin](http://wordpress.org/extend/plugins/styles).
...
1. Upload the `styles-twentyeleven` folder to the `/wp-content/plugins/` directory
